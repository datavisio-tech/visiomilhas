...
import { inspectFinancialAccount } from "../../../../lib/server/financial-integrity";
...
export async function GET(req: Request) {
  ...
  try {
    ...
    const inspection = await inspectFinancialAccount(client as any, {
      organizationId,

...
import { inspectFinancialReplay } from "../../../../lib/server/financial-integrity";
...
export async function GET(req: Request) {
  ...
  try {
    ...
    const inspection = await inspectFinancialReplay(client as any, {
      organizationId,

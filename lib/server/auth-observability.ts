...
export type AuthEventCode =
  ...
  | "ONBOARDING_REQUIRED_REDIRECT"
  | "ONBOARDING_CONTEXT_MISSING"
  | "ONBOARDING_RUNTIME_RECOVERY"
  | "READ_SCOPE_ONBOARDING_RECOVERY"
  | "USER_LOGOUT_SUCCESS"
  | "USER_LOGOUT_FAILED"
  | "SESSION_INVALIDATED"
  | "SESSION_RESTORED"
  | "SESSION_REFRESH_SUCCESS"
  | "SESSION_BROWSER_REOPEN_SUCCESS"
  | "STALE_SESSION_DETECTED"
  | "SESSION_RECOVERY_CLEANUP"
  ...
  | "COMMERCIAL_ACCESS_RECOVERED"
  | "COMMERCIAL_ACCESS_BLOCKED"
  | "PILOT_ACCESS_GRANTED"
  | "PILOT_ACCESS_BLOCKED"
  | "COMMERCIAL_STATE_INCONSISTENT"
  | "ROLLBACK_RECOVERY_TRIGGERED";

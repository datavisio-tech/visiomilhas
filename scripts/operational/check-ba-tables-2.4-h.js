...
/**
 * Manual diagnostic script for staging.
 * - Usage: run manually when validating Better Auth tables.
 * - Not part of runtime or product.
 * - Do not integrate into build or runtime.
 */
const pg = require("pg");

async function checkBetterAuthTables() {
  const client = new pg.Client(
    "postgres://postgres:datavisiopostgres123@72.60.143.197:5432/controle_adm_saas_datavisio",
  );

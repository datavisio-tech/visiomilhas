      ...
      <div className="relative mx-auto grid max-w-7xl gap-16 px-6 py-20 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-28">
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <ShadcnButton variant="outline" href="/app/dashboard" className="px-6 py-3 text-base">
              Ver plataforma
            </ShadcnButton>
          </div>
          ...
          <div className="mt-8 grid gap-3 text-sm text-white/68 sm:grid-cols-3">
            <div className="rounded-2xl border border-white/12 bg-white/6 px-4 py-3 backdrop-blur-xl">
              ...
              <div className="mt-1 text-white/74">Decida com margem na tela</div>
            </div>
            <div className="rounded-2xl border border-white/12 bg-white/6 px-4 py-3 backdrop-blur-xl">
              <div className="text-white">Custo claro</div>
              <div className="mt-1 text-white/74">Saiba o ponto ideal de ação</div>
            </div>
            <div className="rounded-2xl border border-white/12 bg-white/6 px-4 py-3 backdrop-blur-xl">
              <div className="text-white">Tudo em ordem</div>
              <div className="mt-1 text-white/74">Programas, contas e histórico</div>
            </div>
          </div>
        </div>
        ...
        <div className="relative flex items-center justify-center lg:justify-end">
          ...
          <div className="relative w-full max-w-[620px] rounded-[2rem] border border-white/12 bg-white/6 p-4 shadow-[0_24px_120px_rgba(2,6,23,0.6)] backdrop-blur-2xl lg:-mr-10">
            <div className="rounded-[1.6rem] border border-white/12 bg-slate-950/92 p-4">
              <div className="flex items-center justify-between border-b border-white/10 pb-4">
                <div>
                  <div className="text-xs uppercase tracking-[0.28em] text-white/58">Painel em tempo real</div>
              ...
              <div className="mt-4 grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
                <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-white/72">Rentabilidade acumulada</div>
                  ...
                  <div className="mt-5 h-48 rounded-2xl bg-[linear-gradient(180deg,rgba(124,58,237,0.22),rgba(14,165,233,0.08))] p-4">
                ...
                <div className="grid gap-4">
                  <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                    <div className="text-xs uppercase tracking-[0.24em] text-white/58">Mix por programa</div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                    <div className="text-xs uppercase tracking-[0.24em] text-white/58">Operação ativa</div>
                    <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
                      <div className="rounded-xl border border-white/8 bg-white/6 p-3">
                        <div className="text-white">24 compras</div>
                        <div className="mt-1 text-white/72">6 em observação</div>
                      </div>
                      <div className="rounded-xl border border-white/8 bg-white/6 p-3">
                        <div className="text-white">8 vendas</div>
                        <div className="mt-1 text-white/72">Margem acima do piso</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-3">
                {[
                  ...
                  <div key={label} className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                    <div className="text-xs uppercase tracking-[0.22em] text-white/58">{label}</div>

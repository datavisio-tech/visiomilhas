    ...
    <section className="relative overflow-hidden bg-slate-950 py-24 text-white">
      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center lg:px-8">
        <div className="mx-auto max-w-3xl rounded-[2rem] border border-white/10 bg-white/6 px-6 py-10 shadow-[0_24px_120px_rgba(2,6,23,0.5)] backdrop-blur-2xl sm:px-10 sm:py-12">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-white/82">Entre com mais controle, menos ruído e uma visão que ajuda a decidir com tranquilidade. É a última virada antes de transformar dados em ação.</p>
          <div className="mt-8 flex justify-center gap-4">
            <ShadcnButton variant="primary" href="/app/onboarding" className="px-6 py-3 text-base shadow-[0_0_32px_rgba(124,58,237,0.42)]">Começar gratuitamente</ShadcnButton>
            <ShadcnButton variant="outline" href="/app/dashboard" className="px-6 py-3 text-base">Ver plataforma</ShadcnButton>
          </div>
        </div>
      </div>
    </section>
